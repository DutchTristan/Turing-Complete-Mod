...
import kosmek.turing_complete.block.NAND_Gate_Block;
import kosmek.turing_complete.block.Redstone_Bridge_Block;
import kosmek.turing_complete.block.*;
import kosmek.turing_complete.multiblock.Full_Adder;
import kosmek.turing_complete.multiblock.Half_Adder;
...
public class BlockInit {
    ...
    //public static final MEMORY_Cell_Block MEMORY_CELL = registerWithItem("memory_cell_gate", new MEMORY_Cell_Block(AbstractBlock.Settings.create().breakInstantly().sounds(BlockSoundGroup.STONE).pistonBehavior(PistonBehavior.DESTROY)));
    ...
    public static <T extends Block> T register(String name, T block){
        return Registry.register(Registries.BLOCK, new Identifier(TuringCompleteUnofficial.MOD_ID,name), block);
    }
